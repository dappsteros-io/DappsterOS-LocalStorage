...
readonly CASA_SERVICES=(
    "dappsteros-local-storage.service"
)

readonly CASA_EXEC=dappsteros-local-storage
readonly CASA_CONF=/etc/dappsteros/local-storage.conf
readonly CASA_DB=/var/lib/dappsteros/db/local-storage.db
