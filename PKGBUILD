...
pkgname=dappsteros-local-storage
pkgver=0.4.0
pkgrel=1
pkgdesc="Local Storage service provides local storage and disk management functionalities to DappsterOS."
arch=('x86_64' 'aarch64' 'armv7h')
url="https://github.com/dappsteros-io/DappsterOS-LocalStorage"
license=('APACHE')
groups=('dappsteros')
backup=('etc/dappsteros/local-storage.conf')
source_x86_64=(
...
package() {
	...
	install -Dm644 "${_sysdir}/etc/dappsteros/${_name}.conf.sample" "${pkgdir}/etc/dappsteros/${_name}.conf"
