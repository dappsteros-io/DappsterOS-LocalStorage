...
const (
	localStorageConfigDirPath  = "/etc/dappsteros"
	localStorageConfigFilePath = "/etc/dappsterosrosros/local-storage.conf"
	localStorageName           = "dappsteros-local-storage.service"
	localStorageNameShort      = "local-storage"
)

//go:embedded ../../build/sysroot/etc/dappsterosrosros/local-storage.conf.sample
